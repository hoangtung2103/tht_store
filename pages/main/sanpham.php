...
while ($row_chitiet = mysqli_fetch_array($query_chitiet)) {
  ?>
  <p class="chitiet"> <a href="index.php?quanly=home">Home </a> / <?php echo $row_chitiet['tendanhmuc'] ?> /
    <?php echo $row_chitiet['tensanpham'] ?> </p>
  <div class="main1">
    ...
    <div class="wrapper_chitiet">
      <div class="hinhanh_sanpham">
        <div class="container">
          ...
          <div class="row">
            <div class="column">
              <img class="demo cursor" src="admincp/modules/quanlysp/uploads/<?php echo $row_chitiet['hinhanh'] ?>"
                style="width:100%" onclick="currentSlide(1)" alt="">
            </div>
            <div class="column">
              <img class="demo cursor" src="admincp/modules/quanlysp/uploads/<?php echo $row_chitiet['hinhanh2'] ?>"
                style="width:100%" onclick="currentSlide(2)" alt="">
            </div>
            <div class="column">
              <img class="demo cursor" src="admincp/modules/quanlysp/uploads/<?php echo $row_chitiet['hinhanh3'] ?>"
                style="width:100%" onclick="currentSlide(3)" alt="">
            </div>
            <div class="column">
              <img class="demo cursor" src="admincp/modules/quanlysp/uploads/<?php echo $row_chitiet['hinhanh4'] ?>"
                style="width:100%" onclick="currentSlide(4)" alt="">
            </div>
            <div class="column">
              <img class="demo cursor" src="admincp/modules/quanlysp/uploads/<?php echo $row_chitiet['hinhanh5'] ?>"
      ...
      <form method="POST" action="pages/main/themgiohang.php?idsanpham=<?php echo $row_chitiet['id_sanpham'] ?>">
        <div class="chitiet_sanpham">
          <h3 style="padding: 10px;background-color: #f5f5f5;border-radius: 10px;">
            <?php echo $row_chitiet['tensanpham'] ?></h3>
          ...
          <p style="padding: 10px;background-color: #f5f5f5;border-radius: 10px;">Nơi Sản Xuất:
            <span><?php echo $row_chitiet['sanxuat'] ?></span> </p>
          <p style="padding: 10px;background-color: #f5f5f5;border-radius: 10px;">Danh mục sản phẩm :
            <span><?php echo $row_chitiet['tendanhmuc'] ?></span> </p>
          <p style="padding: 10px;background-color: #f5f5f5;border-radius: 10px;">Thương Hiệu :
            <span><?php echo $row_chitiet['tenband'] ?></span> </p>
    ...
    <div class="tabs">
      ...
      <div id="tabs-content">
        ...
        <style>
          /* Thay đổi màu nền và màu văn bản của tab-nav */
          #tabs-nav {
          ...
          #tabs-nav li a {
            color: white;
            /* Đặt màu văn bản thành màu trắng */
          }

          #tab1 {
            border-width: 1px;
            border-color: black;
            /* Đặt màu của viền là màu đen */
          }
        </style>
        <?php
}
