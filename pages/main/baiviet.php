...
?>
<h3 class="bv-title"><a href="index.php?quanly=tintuc">Tin Tức</a> / <span
		style="text-align: center;text-transform: uppercase;"><?php echo $row_bv_title['tenbaiviet'] ?></span></h3>
<div class="main-bv">
	<ul class="baiviet">
		<?php
