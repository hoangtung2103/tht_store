  ...
  <div class="bought-content news-content">
    ...
    <div class="bought-content-box">
      ...
      if (isset($_SESSION['cart'])) {
        ...
        <tr>
          <td colspan="8">
            <p style="float: left; ">Tổng tiền: <span
                style="color:red;font-size: 16px;"><?php echo number_format($tongtien, 0, ',', '.') . 'vnđ' ?></span> </p>
            <br />
      ...
      <?php
        ...
        <tr>
          <td>
            <p style="text-align: center;">Hiện tại giỏ hàng trống</p>
          </td>
