  ...
  <div class="table">
    ...
    while ($row = mysqli_fetch_array($query_lietke_bv)) {
      ...
      <div class="table-sp">
        ...
        <div class="hinhanhbv sp"><img src="modules/quanlybaiviet/uploads/<?php echo $row['hinhanh'] ?>" width="150px">
        </div>
        ...
        <div class="quanlybv sp">
          <a class="xoa-btn" href="modules/quanlybaiviet/xuly.php?idbaiviet=<?php echo $row['id'] ?>">Xoá</a> <a
            class="sua-btn" href="?action=quanlybaiviet&query=sua&idbaiviet=<?php echo $row['id'] ?>">Sửa</a>
        </div>
      </div>
